...
(define-key minibuffer-local-map [up] 'tails-previous-history-element)
(define-key minibuffer-local-completion-map [up] 'tails-previous-history-element)
(define-key minibuffer-local-must-match-map [up] 'tails-previous-history-element)
(define-key minibuffer-local-ns-map [up] 'tails-previous-history-element)

(define-key minibuffer-local-map [down] 'tails-next-history-element)
(define-key minibuffer-local-completion-map [down] 'tails-next-history-element)
(define-key minibuffer-local-must-match-map [down] 'tails-next-history-element)
(define-key minibuffer-local-ns-map [down] 'tails-next-history-element)
